...
function v33RatingTrend(team){
  const t = team || {name:"Milan",abbr:"MIL",league:"Serie A",rating:82,trend:6};
  const points = [
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.8.0-ui-test-v36",{updateViaCache:"none"}).catch(()=>{}));

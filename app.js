...
function v19League(n){
 ...
 document.querySelector("#main").innerHTML=`<div class="page v19-ranking v20-ranking">
   ...
   <div class="v20-rank-list">
     <div class="v20-rank-labels"><span># / SQUADRA</span><span>PG</span><span>ULTIME 5</span><span>RATING</span></div>
     ${ts.map((t,i)=>`<button class="v20-rank-row" data-v19t="${t[0]}" data-v19league="${n}">
       ...
       <span class="v20-form">${v19Form(t.slice(4,9))}</span>
 ...
 document.querySelector("#main").innerHTML=`<div class="page v19-profile v20-profile">
   ...
   <header class="v19-hero v20-hero">
     ...
     <div><small>PROFILO SQUADRA</small><h1>${t[2]}</h1>
       <div class="v20-hero-rating"><span>MODEL RATING</span><strong>${t[9]}</strong><i class="${v20RatingClass(t[9])}"></i></div>
     </div>
   </header>

   <section class="v19-card v20-overview">
     <div class="v19-chead"><b>PANORAMICA MODELLO</b><small>INTELLIGENCE PROFILE</small></div>
   ...
   <section class="v19-card v20-summary-card">
     <div class="v19-chead"><b>INTELLIGENCE SUMMARY</b><small>LETTURA DEL MODELLO</small></div>
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=7.4.0-ui-test-v20",{updateViaCache:"none"}).catch(()=>{}));

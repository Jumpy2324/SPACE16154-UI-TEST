    ...
    document.querySelector('#main').innerHTML=`<div class="page v14-analysis-page">
      ...
      <div class="v14-accordions">
        ...
        <section class="v742-match-form">
          ...
          <div class="v742-form-team"><span>${realCrest(h)}<b>${realEsc(h.name)}</b></span><div>${realFormDots(hm.form)}</div><em>${hm.sample}/5</em></div>
          <div class="v742-form-team"><span>${realCrest(a)}<b>${realEsc(a.name)}</b></span><div>${realFormDots(am.form)}</div><em>${am.sample}/5</em></div>
        </section>

...
const CONFIG={
  version:"12.1.0-v71-mobile-shell",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.0-v71-mobile-shell",{updateViaCache:"none"}).catch(()=>{}));

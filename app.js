  ...
  document.querySelector("#main").innerHTML=`<div class="page v2-dashboard">
   ...
   <section class="v6-hero-combined">
    ...
    ${pred?(()=>{const b1=v61UniqueBest([pred.one,pred.x,pred.two]),bg=v61UniqueBest([pred.gg,pred.ng]),bo=v61UniqueBest([pred.over,pred.under]);return `
      <div class="v2-1x2">
       <div class="${pred.one===b1?"v61-best":""}"><span>1</span><strong>${pred.one}%</strong><i></i></div>
       <div class="${pred.x===b1?"v61-best":""}"><span>X</span><strong>${pred.x}%</strong><i></i></div>
       <div class="${pred.two===b1?"v61-best":""}"><span>2</span><strong>${pred.two}%</strong><i></i></div>
      </div>
      <div class="v2-other-markets">
       <div class="v2-submarket"><b>GOL / NO GOL</b><div>
       ...
       <div class="v2-submarket"><b>OVER / UNDER 2.5</b><div>
 ...
 try{
  ...
  const render=()=>{
    ...
    root.innerHTML=`<section class="m13-page v712-match-center">
      ...
      <div class="v712-league-filters">
        <button class="${leagueFilter==="all"?"active":""}" data-v712-league="all">TUTTI</button>
        ${leagues.map(l=>`<button class="${leagueFilter===l.key?"active":""}" data-v712-league="${l.key}">${v60LeagueLogo(l)}<span>${realEsc(l.name)}</span></button>`).join("")}
      </div>
        ...
        ${visible.length?visible.map(f=>{
          ...
          return `<article class="v712-fixture-card ${st}" data-real-match="${f.id}">
            <div class="v712-fixture-top">
              <span class="v712-league-mini">${l?v60LeagueLogo(l,true):""}${realEsc(f.leagueName||"")}</span>
    ...
    root.querySelectorAll("[data-v712-league]").forEach(b=>b.onclick=()=>{leagueFilter=b.dataset.v712League;render()});
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.3-v71-3-hotfix",{updateViaCache:"none"}).catch(()=>{}));

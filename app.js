...
const CONFIG={
  version:"12.1.6-v71-6-dashboard-sheet",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.6-v71-6-dashboard-sheet",{updateViaCache:"none"}).catch(()=>{}));

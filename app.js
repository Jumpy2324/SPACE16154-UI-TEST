...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.1.0-ui-test-v28",{updateViaCache:"none"}).catch(()=>{}));

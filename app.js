...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.1-v71-1-polish",{updateViaCache:"none"}).catch(()=>{}));

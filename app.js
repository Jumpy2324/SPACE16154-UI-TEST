...
const CONFIG={
  version:"12.2.0-v72-analysis-firstpass",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.2.0-v72-analysis-firstpass",{updateViaCache:"none"}).catch(()=>{}));

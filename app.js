...
const CONFIG={
  version:"12.1.8-v71-8-dashboard-refine",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.8-v71-8-dashboard-refine",{updateViaCache:"none"}).catch(()=>{}));

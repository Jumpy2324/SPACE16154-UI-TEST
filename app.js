...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=9.8.0-ui-test-v46",{updateViaCache:"none"}).catch(()=>{}));

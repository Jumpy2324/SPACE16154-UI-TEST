...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.4.0-ui-test-v31",{updateViaCache:"none"}).catch(()=>{}));

...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.0.0-ui-test-v27",{updateViaCache:"none"}).catch(()=>{}));

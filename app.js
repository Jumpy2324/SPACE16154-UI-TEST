...
function v67HistoryWithCurrent(detail,history,teamId){
  ...
  // realMatchDetail calls this only for the two teams of the current fixture.
  // Do not depend on participants[] here: some SportMonks payload variants can be
  // incomplete after FT. Always replace any stale snapshot with the fresh FT fixture.

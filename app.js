...
async function v67RealTeamProfile(payload){
  ...
  try{
    ...
    root.innerHTML=`<div class="page v67-team-page">
      ...
      <section class="v19-card"><div class="v19-chead"><b>FORMA RECENTE</b><span>ULTIME 5</span></div>
        <div class="v67-team-form">${realFormDots(metrics.form)}<strong>${sample}/5</strong></div>
      </section>
  ...
  try{
    ...
    document.querySelector('#main').innerHTML=`<div class="page v14-analysis-page">
      ...
      <div class="v14-accordions">
        ...
        <section class="v74-form-strip"><div class="v74-strip-head"><b>FORMA RECENTE</b><small>ULTIME 5</small></div><div class="v59-form-row"><span>${realEsc(h.name)}</span><b>${realFormDots(hm.form)}</b><em>${hm.sample}/5</em></div><div class="v59-form-row"><span>${realEsc(a.name)}</span><b>${realFormDots(am.form)}</b><em>${am.sample}/5</em></div></section>

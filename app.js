...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=9.7.0-ui-test-v45",{updateViaCache:"none"}).catch(()=>{}));

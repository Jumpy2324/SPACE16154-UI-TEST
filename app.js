...
function v33RatingTrend(teamId,league){
 const t=(V19T[league]||V19T["Serie A"]).find(x=>x[0]===teamId)||(V19T["Serie A"]||[])[0], name=t[2], score=t[9];
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.6.1-ui-test-v34",{updateViaCache:"none"}).catch(()=>{}));

...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=6.2.0-ui-test-v13",{updateViaCache:"none"}).catch(()=>{}));

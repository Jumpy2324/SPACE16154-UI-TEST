...
const CONFIG={
  version:"11.4.0-v64-visual-data",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=11.4.0-v64-visual-data",{updateViaCache:"none"}).catch(()=>{}));

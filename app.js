...
function v33RatingTrend(teamId,league){
 ...
 document.querySelector("#main").innerHTML=`<div class="v19-page v33-page">
   ...
   <section class="v19-card v33-chart-card">
    <div class="v19-chead v35-trend-head"><b>MODEL RATING TREND</b></div>
    <p class="v33-sub">Ultime 5 valutazioni · evoluzione del rating nel tempo</p>
    ...
    <div class="v33-event"><small>4 AGO · PARTITA</small><b>Milan 2–0 Roma</b><span>Rating <strong>82</strong> <em>+3</em></span></div>
   </section>
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.7.0-ui-test-v35",{updateViaCache:"none"}).catch(()=>{}));

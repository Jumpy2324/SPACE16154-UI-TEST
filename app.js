...
const CONFIG={
  version:"10.9.0-v59-compact-five",
...
function v59H2HCard(f){
  ...
  return `<div class="v59-h2h-card">
    <div class="v59-h2h-date">${date}</div>
    <div class="v59-h2h-main">
      <div class="v59-h2h-team home">${realCrest(home)}<span>${realEsc(home.name||"—")}</span></div>
      <div class="v59-h2h-score">${hs??"—"}<em>–</em>${as??"—"}</div>
      <div class="v59-h2h-team away"><span>${realEsc(away.name||"—")}</span>${realCrest(away)}</div>
    </div>
  </div>`;
}
    ...
    document.querySelector('#main').innerHTML=`<div class="page v14-analysis-page">
      ...
      <div class="v14-accordions">
        ...
        <details class="v14-fold">
          ...
          <div class="v14-fold-body v59-formations">${v59FormationField(ctx,h)}${v59FormationField(ctx,a)}</div>
        </details>
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=10.9.0-v59-compact-five",{updateViaCache:"none"}).catch(()=>{}));

...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.2-v71-2-redesign",{updateViaCache:"none"}).catch(()=>{}));

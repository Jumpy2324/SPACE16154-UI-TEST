...
async function performance(){
  ...
  document.querySelector("#main").innerHTML=`<div class="page"><button class="back-btn" data-nav="more">‹ ALTRO</button><div class="eyebrow">MODEL PERFORMANCE</div><h1>PERFORMANCE</h1><p class="subtitle">Solo pronostici pre-match salvati e partite concluse FT.</p>
   ...
   <p class="v7711-note">Programmate e LIVE non entrano nei conteggi. I 50/50 esatti dei mercati binari sono classificati NO PICK. Le vecchie partite vengono recuperate solo quando esiste già uno snapshot pre-match congelato sul dispositivo; i risultati si aggiornano automaticamente a FT.</p>
  </div>`;
  bind();
}

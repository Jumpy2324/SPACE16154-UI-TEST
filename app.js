...
const CONFIG={
  version:"11.8.0-v68-dashboard-matches",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=11.8.0-v68-dashboard-matches",{updateViaCache:"none"}).catch(()=>{}));

...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.3.0-ui-test-v30",{updateViaCache:"none"}).catch(()=>{}));

...
const CONFIG={
  version:"12.1.7-v71-7-centered-league-modal",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.7-v71-7-centered-league-modal",{updateViaCache:"none"}).catch(()=>{}));

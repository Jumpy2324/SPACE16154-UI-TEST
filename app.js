...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=9.3.0-ui-test-v41",{updateViaCache:"none"}).catch(()=>{}));

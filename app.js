...
const CONFIG={
  version:"9.9.0-ui-test-v49-sportmonks-live",
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=10.0.0-ui-test-v50-live-clean",{updateViaCache:"none"}).catch(()=>{}));
...
function fixtureCard(f){
  ...
  return `<article class="v23-match-card">
    ...
    <div class="v23-match-row">
      ...
      ${analysisId?`<button class="v23-analysis" data-analysis="${analysisId}">ANALISI</button>`:`<button class="v23-analysis v48-analysis-soon" data-smfixture="${escapeHtml(localId)}" disabled>DATI</button>`}

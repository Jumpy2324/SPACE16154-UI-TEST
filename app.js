...
window.addEventListener("popstate",e=>{
 ...
 try{
   ...
   else if(s.kind==="team-stats") v29TeamStats(s.team,s.league,s.tab||"generale");
 }finally{
...
function v29TeamStats(teamId,league,tab="generale"){
 const t=(V19T[league]||[]).find(x=>x[0]===teamId); if(!t) return v19League(league);
 ...
 document.querySelector("#main").innerHTML=`<div class="page v29-stats-page">
   ...
   <header class="v29-team-head">${crest(t[1],"")}<div><h1>${t[2]}</h1><small>${league} · STAGIONE 2024/25</small></div></header>
   <div class="v29-title-row"><div><h2>STATISTICHE</h2><p>Dati, metriche e indicatori principali della squadra</p></div><div class="v29-compare-box"><b>MEDIA CAMPIONATO</b><small>${league}</small></div></div>
 ...
 document.querySelectorAll("[data-v29-tab]").forEach(b=>b.onclick=()=>v29TeamStats(teamId,league,b.dataset.v29Tab));
}
...
function v19Team(id,l){
 ...
 document.querySelector("#main").innerHTML=`<div class="page v19-profile v20-profile">
   ...
   <button class="v29-open-stats" data-v29-stats><span>▥</span><b>STATISTICHE SQUADRA</b><em>›</em></button>
 ...
 document.querySelector("[data-v29-stats]").onclick=()=>v29TeamStats(id,l,"generale");
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=8.2.0-ui-test-v29",{updateViaCache:"none"}).catch(()=>{}));

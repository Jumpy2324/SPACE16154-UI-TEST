...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=6.1.0-ui-test-v12",{updateViaCache:"none"}).catch(()=>{}));

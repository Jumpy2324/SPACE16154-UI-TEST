...
const CONFIG={
  version:"12.1.9-v71-9-dashboard-final",
 ...
 try{
  ...
  document.querySelector("#main").innerHTML=`<div class="page v2-dashboard">
   ...
   <section class="v5-upcoming">
    ...
    </div>`).join("")||`<div class="empty-note">Nessun'altra partita disponibile.</div>`}</div>
   </section>
  </div>`;
  bind();
  document.querySelectorAll("[data-v63-date]").forEach(b=>{
...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=12.1.9-v71-9-dashboard-final",{updateViaCache:"none"}).catch(()=>{}));

...
function v7713TrackerStatusHtml(){
  ...
  return `<div class="v7713-tracker-status">
    <div><b>TRACKER AUTOMATICO</b><strong>${s.running?"IN CORSO":"ATTIVO"}</strong></div>
    <p>Ultimo controllo: <b>${when}</b> · snapshot congelati: <b>${count}</b> · fixture future viste: <b>${s.upcoming_seen??"—"}</b></p>

...
route("dashboard");
if("serviceWorker"in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./sw.js?v=5.9.0-ui-test-v10",{updateViaCache:"none"}).catch(()=>{}));
